...
def main(sess: Session) -> T.Variant:
    ...
    mv = register_model(sess, "BANANA_QUALITY", "DEV", model, model_name="BANANA_MODEL", metrics_train=metrics_train, metrics_test=metrics_test)


    return print("REGISTRO DE MODELO EXITOSO")
